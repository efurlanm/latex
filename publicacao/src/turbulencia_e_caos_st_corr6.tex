...
%
%\begin{figure}[ht]
%\centering \resizebox{15cm}{!}{\includegraphics{img/logistico1.png}\includegraphics{img/logistico2.png}}\\ \resizebox{15cm}{!}{\includegraphics{img/logistico3.png} \includegraphics{img/logistico4.png}}
...
%\begin{figure}[ht]
%\centering
%\resizebox{15cm}{!}{\includegraphics{img/logisticoci.png}\includegraphics{img/logisticocidiff.png}}
...
%\begin{figure}[ht]
%\centering
%\resizebox{15cm}{!}{\includegraphics{img/henon.png}\includegraphics{img/henonamp1.png}}\\ \resizebox{15cm}{!}{\includegraphics{img/henonamp2.png} \includegraphics{img/henonamp3.png}}
...
%
%\begin{figure}[ht]
%\centering \resizebox{10cm}{!}{\includegraphics{img/henonlyapunov.png}} 
%\centering \resizebox{13cm}{!}{\includegraphics{img/henonlyapunovgrid.png}} 
...
%
%\begin{figure}[ht]
%\centering \resizebox{13cm}{!}{\includegraphics{img/rolo.png}} 
...
%\begin{figure}[ht]
%\centering 
%\resizebox{15cm}{!}{\includegraphics{img/lorenzst.png}\includegraphics{img/lorenzstci.png}}
...
%
%\begin{figure}[ht]
%\centering \resizebox{13cm}{!}{\includegraphics{img/lorenzatratorproj.png} } 
...
%
%\begin{figure}[ht]
%\centering \resizebox{13cm}{!}{\includegraphics{img/DaVinci3.png}}
%\centering \resizebox{10cm}{!}{\includegraphics{img/DaVincipb.png}} opcao preto e branco!!!
...
%
%\begin{figure}[ht]
%\centering \resizebox{15cm}{!}{\includegraphics{img/vulcaoturb.png}}
...
%
%\begin{figure}[ht]
%\centering \resizebox{9cm}{!}{\includegraphics{img/reynoldstomomasa.png}}
...
%
%\begin{figure}[ht]
%\centering \resizebox{13cm}{!}{\includegraphics{img/velocidadevert.png}}
...
%
%\begin{figure}[ht]
%\centering \resizebox{13cm}{!}{\includegraphics{img/espectroesboco4.pdf}}
...
% \begin{figure}[!ht]
% \begin{center}
% \resizebox{13cm}{!}{\input{img/espectroesboco5.pdftex_t}}
% \caption{Representação esquemática do espectro da ECT em escala $\log$-$\log$.}
...
%
%\begin{figure}[ht]
%\centering \resizebox{13cm}{!}{\includegraphics{img/bolzan.pdf}}
